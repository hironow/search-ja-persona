...
def test_ensure_dataset_cached_invokes_load_dataset(
    ...
    config = datasets.DatasetCacheConfig(
        cache_dir=tmp_path, split="train", force_download=False
    )
...
def test_ensure_dataset_cached_can_force_download(
